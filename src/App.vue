<template>
  <div id="app">
    ...
    <div id="app" class="csvForm container-fluid">
      <div class="row">
        <div class="col-sm">
          <json-to-geojson-form
            placeholder="Put ArcGIS JSON here"
            @geojson="onGeoJson"
          ></json-to-geojson-form>
        </div>
        <div class="col-sm">
    ...
    <footer>
      ...
      <a
        class="github-button"
        href="https://github.com/gavinr/arcgis-json-to-geojson"
        data-show-count="true"
        aria-label="Star gavinr/arcgis-json-to-geojson on GitHub"
        >Star</a
      ><br />
